...
function crazyDiff(a) {
  ...
  console.log("crazyDiff:", crazyDiff(8));
...
function check3and7(num) {
    if (num >"0") {
        ...
        console.log(num + " not positive number");
    }       
}
...
console.log(upperFirst(wordsinside));
...
console.log(cutString(wordsinside));
